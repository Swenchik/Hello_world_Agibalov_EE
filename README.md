...
## ⚒️Что было сделано:
✔️ Зарегистрирован аккаунт на **GitHub**.

✔️ Настроен редактор **VS Code** (установлены расширения для Python).

✔️ Создан первый удаленный репозиторий.

✔️ Изучен синтаксис разметки **Markdown**.
